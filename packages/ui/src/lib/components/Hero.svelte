...
<section class="px-3 pt-24 sm:px-6 lg:pt-28">
  <div
    class="on-dark relative overflow-hidden rounded-4xl border border-fg/10 bg-band px-4 pb-14 pt-16 sm:px-8 lg:pb-20 lg:pt-24"
  >
    <div
